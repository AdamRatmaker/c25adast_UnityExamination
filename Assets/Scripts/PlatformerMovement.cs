...
{
    public Animator adamsAnimator;
    public float currentVelocity = 5;
    ...
    void Update()
    {
        float currentVelocityX = Mathf.Abs(rb.linearVelocityX);
    ...
    private void FixedUpdate()
    {
        ...
        {
            float absoluteVelocityX = Mathf.Abs(currentVelocity);
            adamsAnimator.SetFloat("velocityX", absoluteVelocityX);
        }
    }
